...
export class GoogleMap extends Container {
    ...
    prepareData(context, instance) {
        ...
        if (!sameLatLng(data.center, rawData.center))
        ...
        if (el) {
            ...
            if (widget.center && widget.center.bind) {
                map.addListener('center_changed', () => {
                    ...
                    instance.set('center', cdata);
                    //dirty fix, signal that the component itself didn't actually change
                    instance.cached.rawData.center = cdata;
                });
            }
            ...
            if (widget.zoom && widget.zoom.bind) {
                map.addListener('zoom_changed', () => {
                    ...
                    //dirty fix, signal that the component itself didn't actually change
                    instance.cached.rawData.zoom = zoom;
                });
            }
