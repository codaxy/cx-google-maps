...
export interface MarkerProps extends PureContainerProps {
    /**
     ...
     */
    attribution?: Prop<google.maps.places.Attribution>;
    ...
    /**
     * Additional options for the native `google.maps.Marker`.
     * Structured/bindable.
     */
     ...
     */
    onAnimationChanged?: (e: any, instance: Instance, marker: google.maps.Marker) => void;

    /**
     * Fired when the marker is clicked.
     */
    onClick?: (e: any, instance: Instance, marker: google.maps.Marker) => void;

    /**
     * Fired when the marker’s clickable state changes.
     */
    onClickableChanged?: (e: any, instance: Instance, marker: google.maps.Marker) => void;

    /**
     * Fired when the marker’s cursor property changes.
     */
    onCursorChanged?: (e: any, instance: Instance, marker: google.maps.Marker) => void;

    /**
     * Fired when the marker is double-clicked.
     */
    onDblClick?: (e: any, instance: Instance, marker: google.maps.Marker) => void;

    /**
     * Fired repeatedly while the marker is dragged.
     */
    onDrag?: (e: any, instance: Instance, marker: google.maps.Marker) => void;

    /**
     * Fired when the user finishes dragging the marker.
     */
    onDragEnd?: (e: any, instance: Instance, marker: google.maps.Marker) => void;

    /**
     * Fired when the marker’s draggable state changes.
     */
    onDraggableChanged?: (e: any, instance: Instance, marker: google.maps.Marker) => void;

    /**
     * Fired when the user starts dragging the marker.
     */
    onDragStart?: (e: any, instance: Instance, marker: google.maps.Marker) => void;

    /**
     * Fired when the marker’s flat property changes.
     */
    onFlatChanged?: (e: any, instance: Instance, marker: google.maps.Marker) => void;

    /**
     * Fired when the marker’s icon changes.
     */
    onIconChanged?: (e: any, instance: Instance, marker: google.maps.Marker) => void;

    /**
     * Fired when the user presses the mouse button down on the marker.
     */
    onMouseDown?: (e: any, instance: Instance, marker: google.maps.Marker) => void;

    /**
     * Fired when the mouse pointer leaves the marker.
     */
    onMouseOut?: (e: any, instance: Instance, marker: google.maps.Marker) => void;

    /**
     * Fired when the mouse pointer enters the marker.
     */
    onMouseOver?: (e: any, instance: Instance, marker: google.maps.Marker) => void;

    /**
     * Fired when the user releases the mouse button over the marker.
     */
    onMouseUp?: (e: any, instance: Instance, marker: google.maps.Marker) => void;

    /**
     * Fired when the marker’s position changes.
     */
    onPositionChanged?: (e: any, instance: Instance, marker: google.maps.Marker) => void;

    /**
     * Fired when the user right-clicks the marker.
     */
    onRightClick?: (e: any, instance: Instance, marker: google.maps.Marker) => void;

    /**
     * Fired when the marker’s shape changes.
     */
    onShapeChanged?: (e: any, instance: Instance, marker: google.maps.Marker) => void;

    /**
     * Fired when the marker’s title changes.
     */
    onTitleChanged?: (e: any, instance: Instance, marker: google.maps.Marker) => void;

    /**
     * Fired when the marker’s visible property changes.
     */
    onVisibleChanged?: (e: any, instance: Instance, marker: google.maps.Marker) => void;

    /**
     * Fired when the marker’s z-index changes.
     */
    onZindexChanged?: (e: any, instance: Instance, marker: google.maps.Marker) => void;

    /**
     * Called after the native `google.maps.Marker` is created.
     *
     * @param marker - The native `google.maps.Marker` instance.
     * @param instance - The Cx widget instance.
     */
    pipeInstance?: (marker: google.maps.Marker, instance: Instance) => void;
}

export class Marker extends Widget<MarkerProps> {}
